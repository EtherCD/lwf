...
const toBe = new Uint8Array([
    ...
    0xec, 0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x03, 0xff, 0xda, 0x00,
    ...
    0xc2, 0x30, 0xec, 0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
test("Testing encoding", () => {
    const encode = lwf.encode(object, schema)

    assert.deepEqual(encode, toBe)
})
